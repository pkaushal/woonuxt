  ...
  <footer class="bg-white order-last">
    <div class="container flex flex-wrap justify-between gap-12 my-24 md:gap-24">
      ...
      <div class="w-3/7 lg:w-auto">
        ...
        <div class="text-sm">
          <a class="py-1.5 block" href="https://p3rkstudios.com" target="_blank">About</a>
    ...
    <div class="container border-t flex items-center justify-center mb-4">
      <div class="copywrite">
        <p class="py-4 text-xs text-center">
          <a href="https://myshop.konsoftech.in" :title="`MyShop v${wooNuxtVersionInfo}`">{{ `MyShop v${wooNuxtVersionInfo}` }}</a> - by
          <a href="https://konsoftech.in" title="Konsoftech Solutions" target="_blank">Konsoftech</a>
        </p>
      </div>
